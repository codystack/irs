...
<div class="mb-3 row">
    ...
    <div class="container mb-10">
        ...
        <div class="row mt-4 mb-3" style="display: <?php if (!$type){echo 'none';}else{echo 'flex';}; ?>">
            <div class="col-md-8 col-lg-6 col-12">
        ...
        <div class="row mt-4 mb-3" style="display: <?php if (!$source_address){echo 'none';}else{echo 'flex';}; ?>">
            <div class="col-md-8 col-lg-6 col-12">
        ...
        <div class="row mt-4 mb-3" style="display: <?php if (!$source_port){echo 'none';}else{echo 'flex';}; ?>">
            <div class="col-md-8 col-lg-6 col-12">
        ...
        <div class="row mt-4 mb-3" style="display: <?php if (!$destination_address){echo 'none';}else{echo 'flex';}; ?>">
            <div class="col-md-8 col-lg-6 col-12">
        ...
        <div class="row mt-4 mb-3" style="display: <?php if (!$destination_port){echo 'none';}else{echo 'flex';}; ?>">
            <div class="col-md-8 col-lg-6 col-12">
        ...
        <div class="row mt-4 mb-3" style="display: <?php if (!$time){echo 'none';}else{echo 'flex';}; ?>">
            <div class="col-md-8 col-lg-6 col-12">
        ...
        <div class="row mt-4 mb-3" style="display: <?php if (!$request_url){echo 'none';}else{echo 'flex';}; ?>">
            <div class="col-md-8 col-lg-6 col-12">
        ...
        <div class="row mt-4 mb-3" style="display: <?php if (!$request_method){echo 'none';}else{echo 'flex';}; ?>">
            <div class="col-md-8 col-lg-6 col-12">
        ...
        <div class="row mt-4 mb-3" style="display: <?php if (!$device_action){echo 'none';}else{echo 'flex';}; ?>">
            <div class="col-md-8 col-lg-6 col-12">
        ...
        <div class="row mt-4 mb-3" style="display: <?php if (!$process){echo 'none';}else{echo 'flex';}; ?>">
            <div class="col-md-8 col-lg-6 col-12">
        ...
        <div class="row mt-4 mb-3" style="display: <?php if (!$parent_process){echo 'none';}else{echo 'flex';}; ?>">
            <div class="col-md-8 col-lg-6 col-12">
        ...
        <div class="row mt-4 mb-3" style="display: <?php if (!$parent_process_md5){echo 'none';}else{echo 'flex';}; ?>">
            <div class="col-md-8 col-lg-6 col-12">
        ...
        <div class="row mt-4 mb-3" style="display: <?php if (!$firewall_action){echo 'none';}else{echo 'flex';}; ?>">
            <div class="col-md-8 col-lg-6 col-12">
