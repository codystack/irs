                    ...
                    <header class="border-bottom mb-10">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12">
                                <h1 class="ls-tight">Closed Alerts</h1>
                            </div>
                        </div>
                        <ul class="nav nav-tabs nav-tabs-flush gap-6 overflow-x border-0 mt-4">
                            ...
                            <li class="nav-item"><a href="closed-alerts" class="nav-link active">Closed Alerts</a></li>
                        </ul>
                    </header>
                    ...
                    <div class="card mb-7">
                        <div class="card-body pb-0">
                            <div class="table-responsive mb-10 mt-5">
                                <table id="closedAlert" class="table table-hover table-striped table-sm table-nowrap">
                                    <thead>
                                        <tr>
                                            <th scope="col">Rule Name</th>
                                            <th scope="col" class="d-xl-table-cell">Severity</th>
                                            <th scope="col" class="d-xl-table-cell">Date Closed</th>
                                            <th scope="col">Event ID</th>
                                            <th scope="col">Type</th>
                                            <th scope="col" class="d-xl-table-cell text-end">Result</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>1.23</td>
                                            <td class="text-end"><button type="button" class="btn btn-sm btn-success btn-xs text-white"><i class="bi bi-check2"></i></button></td>
                                            <td class="text-end dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a href="#!" class="dropdown-item">Re-investigate</a>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
